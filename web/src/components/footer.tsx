  ...
  return (
    <footer className="container space-y-4 border-t border-zinc-300 py-6 text-center">
      ...
      <div className="space-y-1">
        ...
        <img src={logo} alt="EcompJr" className="mx-auto w-24" />
      </div>
    </footer>
  )
}
